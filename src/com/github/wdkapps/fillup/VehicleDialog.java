...
public class VehicleDialog {
	...
	public static Dialog create(
    	...
    	final EditText textVehicleName = (EditText)dialog.findViewById(R.id.textVehicleName);
    	final EditText textVehicleTankSize = (EditText)dialog.findViewById(R.id.textVehicleTankSize);
	 ...
	 * @return boolean - true = valid.
	 */
	private static boolean isValidBrand(String name) {
	 ...
	 * @return boolean - true = valid.
	 */
	private static boolean isValidPlate(String name) {
